...
Como não obtivemos pleno sucesso com esta abordagem, e percebemos que, de certa forma, o que queríamos que o AG descobrisse era as funções de rotação as quais sabíamos suas respectivas imagens conforme já descrito anteriormente (pois utilizamos tais valores para treinar a rede neural), fizemos testes com AG sem o simulador para tentar aproximar com séries de Fourier
